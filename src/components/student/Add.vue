...
<template>
    ...
    <form @submit.prevent="handleAddStudentForm" class="w-full" id="AddStudentForm">
        <div class="flex items-center m-6">
            ...
            <div class="w-4/5">
                <input type="text" id="stuname" v-model.trim="formData.stuname"
                    class="border-2 border-gray-200 w-full py-2 px-4" placeholder="write yur name" required />
            </div>
        </div>
        <div class="flex items-center m-6">
            <div class="w-1/5">
            ...
            <div class="w-4/5">
                <input type="email" id="email" v-model.trim="formData.email"
                    class="border-2 border-gray-200 w-full py-2 px-4" placeholder="write yur email" required />
            </div>
        </div>
