...
const { studentData, error, statusCode, getSingleStudent, updateStudent } = useStudent();
...
<template>
    ...
    <form @submit.prevent="handleUpdateStudentForm" class="w-full" v-else-if="studentData">
